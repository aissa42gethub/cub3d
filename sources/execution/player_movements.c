...
void rotate_player(t_cub *cub, int keycode)
{
    ...
    cub->player.dir_x = cub->player.dir_x * cos(rot_angle) - cub->player.dir_y * sin(rot_angle);
    cub->player.dir_y = old_dir_x * sin(rot_angle) + cub->player.dir_y * cos(rot_angle);
    old_plane_x = cub->player.plane_x;
    cub->player.plane_x = cub->player.plane_x * cos(rot_angle) - cub->player.plane_y * sin(rot_angle);
    cub->player.plane_y = old_plane_x * sin(rot_angle) + cub->player.plane_y * cos(rot_angle);
}
